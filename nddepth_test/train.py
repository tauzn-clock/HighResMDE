...
def main():
    ...
    if save_files:
        ...
        command = 'cp nddepth_test/train.py ' + aux_out_path
        os.system(command)
        command = 'mkdir -p ' + networks_savepath + ' && cp nddepth_test/networks/*.py ' + networks_savepath
        os.system(command)
        command = 'mkdir -p ' + dataloaders_savepath + ' && cp nddepth_test/dataloaders/*.py ' + dataloaders_savepath
        os.system(command)
